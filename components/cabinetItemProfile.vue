<template>
  <div>
    <div class="bg-white p-6 rounded-2xl flex flex-col lg:items-start justify-center items-center">
      ...
      <hr class="mt-4 mb-4 w-full hidden lg:block">
      <div class="opacity-45 font-medium text-lg text-center lg:text-start">
      ...
      <div
        class="mt-3 text-xl bg-white pt-2.5 pb-2.5 w-full rounded-3xl text-center text-gray-400 line-clamp-1 leading-none border-2 border-gray-400">
        +7 949 94939192</div>
      <div
        class="mt-3 text-xl bg-white pt-2.5 pb-2.5 w-full rounded-3xl text-center text-gray-400 line-clamp-1 leading-none border-2 border-gray-400">
        вфцвфцв@gmail.com</div>
      <button
        class="mt-3 text-xl bg-custom-green-1000 pt-3 pb-3 w-full rounded-3xl text-white line-clamp-1 leading-none">Редактировать</button>
    </div>
    <div class="mt-3 bg-white rounded-2xl flex flex-col items-start p-6">
      ...
      <button
        class="mt-3 flex justify-center gap-3 text-xl bg-white pt-2.5 pb-2.5 w-full rounded-3xl text-custom-green-1000 line-clamp-1 leading-none border-2 border-custom-green-1000">
      ...
      <button
        class="mt-3 text-xl bg-custom-green-1000 pt-3 pb-3 w-full rounded-3xl text-white line-clamp-1 leading-none">Посмотреть
        рефералов</button>
    </div>
  </div>
</template>
...
.cabinet-item-profile-description {
  max-width: 250px;
}
</style>
<script lang="ts">
