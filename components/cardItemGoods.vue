<template>
  <div class="bg-white rounded-lg md mt-3 container mx-auto max-w-7xl pt-10 pl-14 pb-10 pr-14">
    <h2 class="text-4xl font-semibold mt-4 opacity-85 text-custom-green-1000">Товары</h2>
