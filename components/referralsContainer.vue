    ...
    <div data-v-5bb0bdcf="" class="sort mt-4">
      <div data-v-5bb0bdcf="">
        <ul
          ...
          <li data-v-5bb0bdcf="">1 уровень <div class="w-full h-1.5 mt-1 bg-custom-green-1200 active"></div>
          </li>
            ...
            <div class="flex gap-3 items-center">
              ...
              <div>
                ...
                <div class="flex gap-3 mt-2 flex-col justify-start items-start md:flex-row">
                  <div class="border-2 rounded-xl pr-4 pl-4 text-red-500 border-red-500">
                    Консультант
                  </div>
                  <div class="border-2 rounded-lg pr-4 pl-4  text-gray-500 bg-gray-100">
                    35 000 Рублей
                  </div>
                </div>
              </div>
  ...
  <div class="bg-white w-full rounded-2xl p-6">
    <div class="flex justify-between items-start md:items-center flex-col md:flex-row">
      ...
      <button
        ...
        <p class="text">
          https://ref.dawd[paццвфвфцвфцв
        </p>
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
          xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
          data-v-inspector="components/cabinetItemProfile.vue:32:9" data-v-f992db80="">
          <mask id="mask0_517_7" style="mask-type:alpha;" maskUnits="userSpaceOnUse" x="0" y="0" width="18" height="18"
            data-v-inspector="components/cabinetItemProfile.vue:34:11" data-v-f992db80="">
            <rect width="18" height="18" fill="url(#pattern0_517_7)"
              data-v-inspector="components/cabinetItemProfile.vue:35:13" data-v-f992db80=""></rect>
          </mask>
          <g mask="url(#mask0_517_7)" data-v-inspector="components/cabinetItemProfile.vue:37:11" data-v-f992db80="">
            <rect x="-3" y="-7" width="40" height="35" fill="#A7D476"
              data-v-inspector="components/cabinetItemProfile.vue:38:13" data-v-f992db80=""></rect>
          </g>
          <defs data-v-inspector="components/cabinetItemProfile.vue:40:11" data-v-f992db80="">
            <pattern id="pattern0_517_7" patternContentUnits="objectBoundingBox" width="1" height="1"
              data-v-inspector="components/cabinetItemProfile.vue:41:13" data-v-f992db80="">
              <use xlink:href="#image0_517_7" transform="scale(0.00195312)"
                data-v-inspector="components/cabinetItemProfile.vue:42:15" data-v-f992db80=""></use>
            </pattern>
