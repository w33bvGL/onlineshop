    ...
    <div class="sort bg-gray-100 rounded-2xl pr-4 pl-4">
      <div>
        <ul
          ...
          <li :class="{ 'opacity-85': selectedCategory === 'electronics', 'opacity-45': selectedCategory !== 'electronics' }"
          ...
          <li :class="{ 'opacity-85': selectedCategory === 'creativity', 'opacity-45': selectedCategory !== 'creativity' }"
        ...
        <div class="flex justify-between w-full">
          <div>
            <div class="flex gap-2 items-center">
              <h5 class="font-semibold text-2xl">{{ product.price }} Р</h5>
              <span class="text-sm bg-red-500 pr-2 pt-0.5 pb-0.5 pl-2 text-white rounded-lg">{{ product.points }} SB</span>
            </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const products = ref([
      { id: 1, category: 'electronics', price: '2 300', points: '112', description: 'Lorem Ipsum - это текст-"рыба", часто используемый в печати и вэб-дизайне.', image: '' },
      { id: 2, category: 'children', price: '1 500', points: '80', description: 'Lorem Ipsum является стандартным видом текста.', image: '' },
      { id: 3, category: 'books', price: '500', points: '20', description: 'Lorem Ipsum является стандартным видом текста.', image: '' },
      { id: 4, category: 'creativity', price: '700', points: '30', description: 'Lorem Ipsum является стандартным видом текста.', image: '' },
      { id: 5, category: 'home', price: '2 000', points: '100', description: 'Lorem Ipsum является стандартным видом текста.', image: '' },
      { id: 6, category: 'sports', price: '1 800', points: '90', description: 'Lorem Ipsum является стандартным видом текста.', image: '' },
    ]);
